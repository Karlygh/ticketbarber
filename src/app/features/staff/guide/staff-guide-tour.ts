...
export const STAFF_GUIDE_STEPS: StaffGuideStep[] = [
  ...
  },
  {
    ...
    title: 'Abrir jornada',
    body: 'Usa este boton al empezar el dia para seleccionar que barberos trabajan hoy y activar la jornada visible en kiosk y TV.',
    placement: 'bottom',
    allowNextWhenMissing: false
  },
  {
  ...
  },
  {
    ...
    body: 'Con Anterior y Siguiente gestionas el turno actual de cada barbero. Solo funciona cuando la jornada esta abierta.',
    placement: 'top',
    allowNextWhenMissing: true,
    missingBody: 'Todavia no hay barberos creados, asi que no aparece la cola individual. En cuanto tengas al menos uno, aqui podras avanzar o retroceder sus turnos.'
  },
  {
    ...
    body: 'Desde Estado puedes marcar a un barbero como disponible, en descanso u oculto, y tambien borrarlo si hace falta.',
    placement: 'left',
    allowNextWhenMissing: true,
